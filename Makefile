...
stm32-asv.bin: patch-airsense patches/graph.bin patches/squarewave_asv.bin patches/asv_task_wrapper.bin
...
binaries: patches/ventilator.bin patches/graph.bin patches/squarewave.bin patches/squarewave_asv.bin patches/asv_task_wrapper.bin
